...
declare class ApiService {
  ...
  createClient<Paths extends {}>(
    clientOptions: Parameters<typeof openapi_fetch__default>[0],
  ): {
    GET<P extends PathsWithMethod<Paths, "get">>(
      url: P,
      init?: FetchOptions<FilterKeys<Paths[P], "get">>,
    ): Promise<{
      data: openapi_fetch.ParseAsResponse<
        openapi_typescript_helpers.SuccessResponse<
          openapi_typescript_helpers.ResponseObjectMap<Paths[P]["get"]>,
          `${string}/${string}`
        >,
        openapi_fetch.ParamsOption<FilterKeys<Paths[P], "get">> &
          openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "get">> & {
            baseUrl?: string;
            querySerializer?:
              | openapi_fetch.QuerySerializerOptions
              | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "get">>;
    ...
    PUT<P extends PathsWithMethod<Paths, "put">>(
      ...
      data: openapi_fetch.ParseAsResponse<
        openapi_typescript_helpers.SuccessResponse<
          openapi_typescript_helpers.ResponseObjectMap<Paths[P]["put"]>,
          `${string}/${string}`
        >,
        openapi_fetch.ParamsOption<FilterKeys<Paths[P], "put">> &
          openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "put">> & {
            baseUrl?: string;
            querySerializer?:
              | openapi_fetch.QuerySerializerOptions
              | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "put">>;
            bodySerializer?: openapi_fetch.BodySerializer<
    ...
    PATCH<P extends PathsWithMethod<Paths, "patch">>(
      ...
      data: openapi_fetch.ParseAsResponse<
        openapi_typescript_helpers.SuccessResponse<
          openapi_typescript_helpers.ResponseObjectMap<Paths[P]["patch"]>,
          `${string}/${string}`
        >,
        openapi_fetch.ParamsOption<FilterKeys<Paths[P], "patch">> &
          openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "patch">> & {
            baseUrl?: string;
            querySerializer?:
              | openapi_fetch.QuerySerializerOptions
              | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "patch">>;
            bodySerializer?: openapi_fetch.BodySerializer<
    ...
    POST<P extends PathsWithMethod<Paths, "post">>(
      ...
      data: openapi_fetch.ParseAsResponse<
        openapi_typescript_helpers.SuccessResponse<
          openapi_typescript_helpers.ResponseObjectMap<Paths[P]["post"]>,
          `${string}/${string}`
        >,
        openapi_fetch.ParamsOption<FilterKeys<Paths[P], "post">> &
          openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "post">> & {
            baseUrl?: string;
            querySerializer?:
              | openapi_fetch.QuerySerializerOptions
              | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "post">>;
            bodySerializer?: openapi_fetch.BodySerializer<
    ...
    DELETE<P extends PathsWithMethod<Paths, "delete">>(
      ...
      data: openapi_fetch.ParseAsResponse<
        openapi_typescript_helpers.SuccessResponse<
          openapi_typescript_helpers.ResponseObjectMap<Paths[P]["delete"]>,
          `${string}/${string}`
        >,
        openapi_fetch.ParamsOption<FilterKeys<Paths[P], "delete">> &
          openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "delete">> & {
            baseUrl?: string;
            querySerializer?:
              | openapi_fetch.QuerySerializerOptions
              | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "delete">>;
            bodySerializer?: openapi_fetch.BodySerializer<
...
type DataModel<T> = components["schemas"][T & keyof components["schemas"]];
