...
import openapi_fetch__default, { FetchOptions } from 'openapi-fetch';
import * as openapi_typescript_helpers from 'openapi-typescript-helpers';
import { PathsWithMethod, FilterKeys } from 'openapi-typescript-helpers';
...
declare class ApiService {
    ...
    createClient<Paths extends {}>(clientOptions: Parameters<typeof openapi_fetch__default>[0]): {
        GET<P extends PathsWithMethod<Paths, "get">>(url: P, init?: FetchOptions<FilterKeys<Paths[P], "get">>): Promise<{
            data: openapi_fetch.ParseAsResponse<openapi_typescript_helpers.SuccessResponse<openapi_typescript_helpers.ResponseObjectMap<Paths[P]["get"]>, `${string}/${string}`>, openapi_fetch.ParamsOption<FilterKeys<Paths[P], "get">> & openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "get">> & {
                baseUrl?: string;
                querySerializer?: openapi_fetch.QuerySerializerOptions | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "get">>;
                bodySerializer?: openapi_fetch.BodySerializer<FilterKeys<Paths[P], "get">>;
                parseAs?: openapi_fetch.ParseAs;
                fetch?: openapi_fetch.ClientOptions["fetch"];
                headers?: openapi_fetch.HeadersOptions;
            } & {
                headers: {
                    Cookie: string;
                    'X-XSRF-TOKEN': string;
                    'Content-Type': string;
                } | [string, string][] | Headers | Record<string, string | number | boolean | (string | number | boolean)[]>;
                cache?: RequestCache;
        ...
        PUT<P extends PathsWithMethod<Paths, "put">>(url: P, init?: FetchOptions<FilterKeys<Paths[P], "put">>): Promise<{
            data: openapi_fetch.ParseAsResponse<openapi_typescript_helpers.SuccessResponse<openapi_typescript_helpers.ResponseObjectMap<Paths[P]["put"]>, `${string}/${string}`>, openapi_fetch.ParamsOption<FilterKeys<Paths[P], "put">> & openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "put">> & {
                baseUrl?: string;
                querySerializer?: openapi_fetch.QuerySerializerOptions | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "put">>;
                bodySerializer?: openapi_fetch.BodySerializer<FilterKeys<Paths[P], "put">>;
                parseAs?: openapi_fetch.ParseAs;
                fetch?: openapi_fetch.ClientOptions["fetch"];
                headers?: openapi_fetch.HeadersOptions;
            } & {
        ...
        POST<P extends PathsWithMethod<Paths, "post">>(url: P, init?: FetchOptions<FilterKeys<Paths[P], "post">>): Promise<{
            data: openapi_fetch.ParseAsResponse<openapi_typescript_helpers.SuccessResponse<openapi_typescript_helpers.ResponseObjectMap<Paths[P]["post"]>, `${string}/${string}`>, openapi_fetch.ParamsOption<FilterKeys<Paths[P], "post">> & openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "post">> & {
                baseUrl?: string;
                querySerializer?: openapi_fetch.QuerySerializerOptions | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "post">>;
                bodySerializer?: openapi_fetch.BodySerializer<FilterKeys<Paths[P], "post">>;
                parseAs?: openapi_fetch.ParseAs;
                fetch?: openapi_fetch.ClientOptions["fetch"];
                headers?: openapi_fetch.HeadersOptions;
            } & {
        ...
        DELETE<P extends PathsWithMethod<Paths, "delete">>(url: P, init?: FetchOptions<FilterKeys<Paths[P], "delete">>): Promise<{
            data: openapi_fetch.ParseAsResponse<openapi_typescript_helpers.SuccessResponse<openapi_typescript_helpers.ResponseObjectMap<Paths[P]["delete"]>, `${string}/${string}`>, openapi_fetch.ParamsOption<FilterKeys<Paths[P], "delete">> & openapi_fetch.RequestBodyOption<FilterKeys<Paths[P], "delete">> & {
                baseUrl?: string;
                querySerializer?: openapi_fetch.QuerySerializerOptions | openapi_fetch.QuerySerializer<FilterKeys<Paths[P], "delete">>;
                bodySerializer?: openapi_fetch.BodySerializer<FilterKeys<Paths[P], "delete">>;
                parseAs?: openapi_fetch.ParseAs;
                fetch?: openapi_fetch.ClientOptions["fetch"];
                headers?: openapi_fetch.HeadersOptions;
            } & {
...
interface LoginAdminByEmailAndPasswordModel {
    email: string;
    password: string;
    language?: string;
    code?: string;
...
declare enum ChecklistStatus {
    Active = 0,
    Templates = 1,
    Ended = 2
}

interface GetChecklistsQuery {
    type?: ChecklistStatus;
    /** @description Search by name of checklist */
    search?: string;
    skip?: number;
    limit?: number;
    sort?: 'name' | 'nameDesc' | 'createdDate' | 'createdDateDesc' | 'startedDate' | 'startedDateDesc';
    /**
...
declare class ChecklistsAPI {
    private apiService;
    constructor(apiService: ApiService);
    setApiService(apiService: ApiService): void;
    getChecklists: (query?: GetChecklistsQuery) => Promise<DataModel<"ChecklistViewModel">[]>;
    getChecklistItems: (checklistId: number) => Promise<DataModel<"ChecklistItemViewModel">[]>;
    setChecklistItemState: (checklistId: number, itemId: number, completeState: boolean) => Promise<DataModel<"ChecklistItemViewModel">>;
}

interface RegisterGroupModel {
    name: string;
    locationID?: number | null;
    userid?: number | null;
    memberEmergency?: boolean;
...
interface AddGroupMemberModel {
    groupId?: number | null;
    Id?: number | null;
    Email?: string | null;
    admin?: boolean;
}
interface GetAdminPanelGroupsQuery {
    Id?: number;
    Skip?: number;
    Limit?: number;
    Asc?: 0 | 1;
...
interface GetGroupMembersQuery {
    skip?: number;
    limit?: number;
}
...
interface GetAdminPanelUsersQuery {
    sort?: string;
    search?: string;
    skip?: number;
    limit?: number;
...
interface ChangeUsersPasswordModel {
    password: string;
}
...
interface CreateEmergencyTypeModel {
    organizationID: number | null;
    color?: string | null;
    icon?: string | null;
    includeCrisisTeam?: boolean;
...
interface PostLoneWorkerTimerModel {
    /** @note Equals 'fcm' */
    deviceId: string;
    dispatchTime: string;
    locationId?: number;
...
declare class LoneWorkerTimerAPI {
    private apiService;
    constructor(apiService: ApiService);
    setApiService(apiService: ApiService): void;
    createLoneWorkerTimer: (body: PostLoneWorkerTimerModel) => Promise<DataModel<"PersonalAlarmViewModel">>;
    activateLoneWorkerTimer: () => Promise<DataModel<"PersonalAlarmViewModel">>;
}
...
declare class MessagesAPI {
    ...
    postMessage: (body: PostMessageModel) => Promise<any>;
    getMessage: (id: number, query?: GetMessageQuery) => Promise<any>;
    postReply: (messageId: number, body: PostReplyModel) => Promise<any>;
    getMessageRecipients: (messageId: number) => Promise<any>;
}

export { AccountAPI, AlarmsAPI, ApiService, ChecklistsAPI, GroupsAPI, LocationsAPI, LoneWorkerTimerAPI, MessagesAPI, OrganizationsAPI, UsersAPI };
